    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="使用帮助" prop="shiyongbangzhu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="使用帮助"
                  v-model="ruleForm.shiyongbangzhu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shiyongbangzhu" label="使用帮助" prop="shiyongbangzhu">
                    <span>{{ruleForm.shiyongbangzhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='shiyongbangzhu'){
            this.ruleForm.shiyongbangzhu = obj[o];
	    this.ro.shiyongbangzhu = true;
            continue;
          }
          if(o=='gengxinshijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xitongbangzhu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xitongbangzhuCrossAddOrUpdateFlag = false;
                  this.parent.search();
