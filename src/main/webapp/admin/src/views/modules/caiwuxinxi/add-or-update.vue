<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="财务类型" prop="caiwuleixing">
          <el-select v-model="ruleForm.caiwuleixing" placeholder="请选择财务类型">
            <el-option
                v-for="(item,index) in caiwuleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="财务类型" prop="caiwuleixing">
	      <el-input v-model="ruleForm.caiwuleixing"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='caiwuleixing'){
            this.ruleForm.caiwuleixing = obj[o];
	    this.ro.caiwuleixing = true;
            continue;
          }
          if(o=='laiyuan'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.caiwuleixingOptions = "收入,支出,投资,其他".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
